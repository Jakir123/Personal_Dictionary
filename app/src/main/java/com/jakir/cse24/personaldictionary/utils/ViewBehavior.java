...
public class ViewBehavior extends CoordinatorLayout.Behavior<ToolbarView> {
...
@Override
public boolean layoutDependsOn(CoordinatorLayout parent, ToolbarView child, View dependency) {
        return dependency instanceof AppBarLayout;
        }

@Override
public boolean onDependentViewChanged(CoordinatorLayout parent, ToolbarView child, View dependency) {
...
private void shouldInitProperties(ToolbarView child, View dependency) {
